...
@JsonDeserialize(
    builder = StatSummary.Builder.class
)
public final class StatSummary {
  ...
  StatSummary(Handle game, List<Stat> stats) {
    this.game = game;
    this.stats = stats;
  }
  ...
  public int hashCode() {
    if (_cachedHashCode == 0) {
      _cachedHashCode = Objects.hash(this.game, this.stats);
    }
  ...
  public String toString() {
    return "StatSummary{" + "game: " + game + ", stats: " + stats + "}";
  }
