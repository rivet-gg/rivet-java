...
@JsonDeserialize(
    builder = StatConfig.Builder.class
)
public final class StatConfig {
  ...
  StatConfig(UUID recordId, UUID iconId, StatFormatMethod format, StatAggregationMethod aggregation,
      StatSortingMethod sorting, int priority, String displayName, Optional<String> postfixSingular,
      Optional<String> postfixPlural, Optional<String> prefixSingular,
  ...
  private boolean equalTo(StatConfig other) {
    return recordId.equals(other.recordId) && iconId.equals(other.iconId) && format.equals(other.format) && aggregation.equals(other.aggregation) && sorting.equals(other.sorting) && priority == other.priority && displayName.equals(other.displayName) && postfixSingular.equals(other.postfixSingular) && postfixPlural.equals(other.postfixPlural) && prefixSingular.equals(other.prefixSingular) && prefixPlural.equals(other.prefixPlural);
  }

  @Override
  public int hashCode() {
    if (_cachedHashCode == 0) {
      _cachedHashCode = Objects.hash(this.recordId, this.iconId, this.format, this.aggregation, this.sorting, this.priority, this.displayName, this.postfixSingular, this.postfixPlural, this.prefixSingular, this.prefixPlural);
    }
  ...
  public String toString() {
    return "StatConfig{" + "recordId: " + recordId + ", iconId: " + iconId + ", format: " + format + ", aggregation: " + aggregation + ", sorting: " + sorting + ", priority: " + priority + ", displayName: " + displayName + ", postfixSingular: " + postfixSingular + ", postfixPlural: " + postfixPlural + ", prefixSingular: " + prefixSingular + ", prefixPlural: " + prefixPlural + "}";
  }
  ...
  public static final class Builder implements RecordIdStage, IconIdStage, FormatStage, AggregationStage, SortingStage, PriorityStage, DisplayNameStage, _FinalStage {
    ...
    public StatConfig build() {
      return new StatConfig(recordId, iconId, format, aggregation, sorting, priority, displayName, postfixSingular, postfixPlural, prefixSingular, prefixPlural);
    }
  }
}
