...
public final class Handle {
  ...
  Handle(UUID gameId, String nameId, String displayName, Optional<String> logoUrl,
  ...
  private boolean equalTo(Handle other) {
    return gameId.equals(other.gameId) && nameId.equals(other.nameId) && displayName.equals(other.displayName) && logoUrl.equals(other.logoUrl) && bannerUrl.equals(other.bannerUrl);
  }

  @Override
  public int hashCode() {
    if (_cachedHashCode == 0) {
      _cachedHashCode = Objects.hash(this.gameId, this.nameId, this.displayName, this.logoUrl, this.bannerUrl);
    }
  ...
  public String toString() {
    return "Handle{" + "gameId: " + gameId + ", nameId: " + nameId + ", displayName: " + displayName + ", logoUrl: " + logoUrl + ", bannerUrl: " + bannerUrl + "}";
  }
