...
public final class Route {
  ...
  Route(String glob, int priority, List<Middleware> middlewares) {
    this.glob = glob;
  ...
  public int hashCode() {
    if (_cachedHashCode == 0) {
      _cachedHashCode = Objects.hash(this.glob, this.priority, this.middlewares);
    }
  ...
  public String toString() {
    return "Route{" + "glob: " + glob + ", priority: " + priority + ", middlewares: " + middlewares + "}";
  }
