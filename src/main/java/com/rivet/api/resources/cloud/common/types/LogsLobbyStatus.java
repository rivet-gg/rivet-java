...
@JsonDeserialize(
    builder = LogsLobbyStatus.Builder.class
)
public final class LogsLobbyStatus {
  ...
  LogsLobbyStatus(EmptyObject running, Optional<LogsLobbyStatusStopped> stopped) {
  ...
  public int hashCode() {
    if (_cachedHashCode == 0) {
      _cachedHashCode = Objects.hash(this.running, this.stopped);
    }
  ...
  public String toString() {
    return "LogsLobbyStatus{" + "running: " + running + ", stopped: " + stopped + "}";
  }
