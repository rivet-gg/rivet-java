...
@JsonDeserialize(
    builder = ValidateGameNamespaceMatchmakerConfigRequest.Builder.class
)
public final class ValidateGameNamespaceMatchmakerConfigRequest {
  ...
  ValidateGameNamespaceMatchmakerConfigRequest(int lobbyCountMax, int maxPlayers) {
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof ValidateGameNamespaceMatchmakerConfigRequest && equalTo((ValidateGameNamespaceMatchmakerConfigRequest) other);
  }
  ...
  public String toString() {
    return "ValidateGameNamespaceMatchmakerConfigRequest{" + "lobbyCountMax: " + lobbyCountMax + ", maxPlayers: " + maxPlayers + "}";
  }
