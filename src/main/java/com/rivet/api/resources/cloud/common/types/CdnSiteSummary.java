...
@JsonDeserialize(
    builder = CdnSiteSummary.Builder.class
)
public final class CdnSiteSummary {
  ...
  CdnSiteSummary(UUID siteId, UUID uploadId, String displayName, String createTs,
  ...
  private boolean equalTo(CdnSiteSummary other) {
    return siteId.equals(other.siteId) && uploadId.equals(other.uploadId) && displayName.equals(other.displayName) && createTs.equals(other.createTs) && contentLength == other.contentLength && complete == other.complete;
  }

  @Override
  public int hashCode() {
    if (_cachedHashCode == 0) {
      _cachedHashCode = Objects.hash(this.siteId, this.uploadId, this.displayName, this.createTs, this.contentLength, this.complete);
    }
  ...
  public String toString() {
    return "CdnSiteSummary{" + "siteId: " + siteId + ", uploadId: " + uploadId + ", displayName: " + displayName + ", createTs: " + createTs + ", contentLength: " + contentLength + ", complete: " + complete + "}";
  }
