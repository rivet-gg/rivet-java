...
public final class Config {
    ...
    private Config(
            Optional<Map<String, GameMode>> gameModes,
            Optional<Captcha> captcha,
            Optional<String> devHostname,
    ...
    private boolean equalTo(Config other) {
        return gameModes.equals(other.gameModes)
                && captcha.equals(other.captcha)
                && devHostname.equals(other.devHostname)
                ...
                && lobbyGroups.equals(other.lobbyGroups);
    }
