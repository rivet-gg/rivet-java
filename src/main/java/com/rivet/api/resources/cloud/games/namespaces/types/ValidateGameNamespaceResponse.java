...
@JsonDeserialize(
    builder = ValidateGameNamespaceResponse.Builder.class
)
public final class ValidateGameNamespaceResponse {
  ...
  ValidateGameNamespaceResponse(List<ValidationError> errors) {
    this.errors = errors;
  }
  ...
  public String toString() {
    return "ValidateGameNamespaceResponse{" + "errors: " + errors + "}";
  }
