...
@JsonDeserialize(
    builder = GameModeRuntimeDocker.Builder.class
)
public final class GameModeRuntimeDocker {
  ...
  GameModeRuntimeDocker(Optional<String> dockerfile, Optional<String> image, Optional<UUID> imageId,
      Optional<List<String>> args, Optional<Map<String, String>> env,
      Optional<NetworkMode> networkMode, Optional<Map<String, GameModeRuntimeDockerPort>> ports) {
  ...
  private boolean equalTo(GameModeRuntimeDocker other) {
    return dockerfile.equals(other.dockerfile) && image.equals(other.image) && imageId.equals(other.imageId) && args.equals(other.args) && env.equals(other.env) && networkMode.equals(other.networkMode) && ports.equals(other.ports);
  }

  @Override
  public int hashCode() {
    if (_cachedHashCode == 0) {
      _cachedHashCode = Objects.hash(this.dockerfile, this.image, this.imageId, this.args, this.env, this.networkMode, this.ports);
    }
  ...
  public String toString() {
    return "GameModeRuntimeDocker{" + "dockerfile: " + dockerfile + ", image: " + image + ", imageId: " + imageId + ", args: " + args + ", env: " + env + ", networkMode: " + networkMode + ", ports: " + ports + "}";
  }
