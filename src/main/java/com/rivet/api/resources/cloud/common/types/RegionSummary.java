...
@JsonDeserialize(
    builder = RegionSummary.Builder.class
)
public final class RegionSummary {
  ...
  RegionSummary(UUID regionId, String regionNameId, String provider, double universalRegion,
      String providerDisplayName, String regionDisplayName) {
  ...
  private boolean equalTo(RegionSummary other) {
    return regionId.equals(other.regionId) && regionNameId.equals(other.regionNameId) && provider.equals(other.provider) && universalRegion == other.universalRegion && providerDisplayName.equals(other.providerDisplayName) && regionDisplayName.equals(other.regionDisplayName);
  }

  @Override
  public int hashCode() {
    if (_cachedHashCode == 0) {
      _cachedHashCode = Objects.hash(this.regionId, this.regionNameId, this.provider, this.universalRegion, this.providerDisplayName, this.regionDisplayName);
    }
  ...
  public String toString() {
    return "RegionSummary{" + "regionId: " + regionId + ", regionNameId: " + regionNameId + ", provider: " + provider + ", universalRegion: " + universalRegion + ", providerDisplayName: " + providerDisplayName + ", regionDisplayName: " + regionDisplayName + "}";
  }
  ...
  public static final class Builder implements RegionIdStage, RegionNameIdStage, ProviderStage, UniversalRegionStage, ProviderDisplayNameStage, RegionDisplayNameStage, _FinalStage {
    ...
    public RegionSummary build() {
      return new RegionSummary(regionId, regionNameId, provider, universalRegion, providerDisplayName, regionDisplayName);
    }
  }
}
