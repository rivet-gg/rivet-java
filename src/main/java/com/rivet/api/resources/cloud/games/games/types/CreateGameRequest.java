...
@JsonDeserialize(
    builder = CreateGameRequest.Builder.class
)
public final class CreateGameRequest {
  ...
  CreateGameRequest(String nameId, String displayName, UUID developerGroupId) {
    this.nameId = nameId;
  ...
  private boolean equalTo(CreateGameRequest other) {
    return nameId.equals(other.nameId) && displayName.equals(other.displayName) && developerGroupId.equals(other.developerGroupId);
  }

  @Override
  public int hashCode() {
    if (_cachedHashCode == 0) {
      _cachedHashCode = Objects.hash(this.nameId, this.displayName, this.developerGroupId);
    }
  ...
  public String toString() {
    return "CreateGameRequest{" + "nameId: " + nameId + ", displayName: " + displayName + ", developerGroupId: " + developerGroupId + "}";
  }
