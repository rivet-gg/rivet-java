...
@JsonDeserialize(
    builder = ValidateGameNamespaceTokenDevelopmentRequest.Builder.class
)
public final class ValidateGameNamespaceTokenDevelopmentRequest {
  ...
  ValidateGameNamespaceTokenDevelopmentRequest(String hostname,
      List<LobbyGroupRuntimeDockerPort> lobbyPorts) {
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof ValidateGameNamespaceTokenDevelopmentRequest && equalTo((ValidateGameNamespaceTokenDevelopmentRequest) other);
  }
  ...
  public int hashCode() {
    if (_cachedHashCode == 0) {
      _cachedHashCode = Objects.hash(this.hostname, this.lobbyPorts);
    }
  ...
  public String toString() {
    return "ValidateGameNamespaceTokenDevelopmentRequest{" + "hostname: " + hostname + ", lobbyPorts: " + lobbyPorts + "}";
  }
