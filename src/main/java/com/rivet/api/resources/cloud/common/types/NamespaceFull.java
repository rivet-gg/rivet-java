...
@JsonDeserialize(
    builder = NamespaceFull.Builder.class
)
public final class NamespaceFull {
  ...
  NamespaceFull(UUID namespaceId, String createTs, String displayName, UUID versionId,
      String nameId, NamespaceConfig config) {
  ...
  private boolean equalTo(NamespaceFull other) {
    return namespaceId.equals(other.namespaceId) && createTs.equals(other.createTs) && displayName.equals(other.displayName) && versionId.equals(other.versionId) && nameId.equals(other.nameId) && config.equals(other.config);
  }

  @Override
  public int hashCode() {
    if (_cachedHashCode == 0) {
      _cachedHashCode = Objects.hash(this.namespaceId, this.createTs, this.displayName, this.versionId, this.nameId, this.config);
    }
  ...
  public String toString() {
    return "NamespaceFull{" + "namespaceId: " + namespaceId + ", createTs: " + createTs + ", displayName: " + displayName + ", versionId: " + versionId + ", nameId: " + nameId + ", config: " + config + "}";
  }
