...
@JsonDeserialize(
    builder = CreateGameCdnSiteRequest.Builder.class
)
public final class CreateGameCdnSiteRequest {
  ...
  CreateGameCdnSiteRequest(String displayName, List<PrepareFile> files) {
  ...
  public int hashCode() {
    if (_cachedHashCode == 0) {
      _cachedHashCode = Objects.hash(this.displayName, this.files);
    }
  ...
  public String toString() {
    return "CreateGameCdnSiteRequest{" + "displayName: " + displayName + ", files: " + files + "}";
  }
