...
@JsonDeserialize(builder = GameLogoUploadPrepareResponse.Builder.class)
public final class GameLogoUploadPrepareResponse {
    private final UUID uploadId;

    private final PresignedRequest presignedRequest;

    private GameLogoUploadPrepareResponse(UUID uploadId, PresignedRequest presignedRequest) {
