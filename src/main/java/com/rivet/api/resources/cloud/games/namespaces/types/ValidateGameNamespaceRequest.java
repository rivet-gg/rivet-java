...
@JsonDeserialize(
    builder = ValidateGameNamespaceRequest.Builder.class
)
public final class ValidateGameNamespaceRequest {
  ...
  ValidateGameNamespaceRequest(String displayName, String nameId) {
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof ValidateGameNamespaceRequest && equalTo((ValidateGameNamespaceRequest) other);
  }

  private boolean equalTo(ValidateGameNamespaceRequest other) {
  ...
  public int hashCode() {
    if (_cachedHashCode == 0) {
      _cachedHashCode = Objects.hash(this.displayName, this.nameId);
    }
  ...
  public String toString() {
    return "ValidateGameNamespaceRequest{" + "displayName: " + displayName + ", nameId: " + nameId + "}";
  }
  ...
  public interface DisplayNameStage {
    ...
    Builder from(ValidateGameNamespaceRequest other);
  }
  ...
  public static final class Builder implements DisplayNameStage, NameIdStage, _FinalStage {
    ...
    @Override
    public Builder from(ValidateGameNamespaceRequest other) {
    ...
    public ValidateGameNamespaceRequest build() {
      return new ValidateGameNamespaceRequest(displayName, nameId);
    }
  }
}
