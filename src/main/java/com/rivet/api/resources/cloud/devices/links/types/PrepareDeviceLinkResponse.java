...
@JsonDeserialize(
    builder = PrepareDeviceLinkResponse.Builder.class
)
public final class PrepareDeviceLinkResponse {
  ...
  PrepareDeviceLinkResponse(UUID deviceLinkId, String deviceLinkToken, String deviceLinkUrl) {
  ...
  private boolean equalTo(PrepareDeviceLinkResponse other) {
    return deviceLinkId.equals(other.deviceLinkId) && deviceLinkToken.equals(other.deviceLinkToken) && deviceLinkUrl.equals(other.deviceLinkUrl);
  }

  @Override
  public int hashCode() {
    if (_cachedHashCode == 0) {
      _cachedHashCode = Objects.hash(this.deviceLinkId, this.deviceLinkToken, this.deviceLinkUrl);
    }
  ...
  public String toString() {
    return "PrepareDeviceLinkResponse{" + "deviceLinkId: " + deviceLinkId + ", deviceLinkToken: " + deviceLinkToken + ", deviceLinkUrl: " + deviceLinkUrl + "}";
  }
