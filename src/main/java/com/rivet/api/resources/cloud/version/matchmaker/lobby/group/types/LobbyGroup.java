...
@JsonDeserialize(
    builder = LobbyGroup.Builder.class
)
public final class LobbyGroup {
  ...
  LobbyGroup(String nameId, List<LobbyGroupRegion> regions, int maxPlayersNormal,
      int maxPlayersDirect, int maxPlayersParty, LobbyGroupRuntime runtime) {
    this.nameId = nameId;
  ...
  private boolean equalTo(LobbyGroup other) {
    return nameId.equals(other.nameId) && regions.equals(other.regions) && maxPlayersNormal == other.maxPlayersNormal && maxPlayersDirect == other.maxPlayersDirect && maxPlayersParty == other.maxPlayersParty && runtime.equals(other.runtime);
  }

  @Override
  public int hashCode() {
    if (_cachedHashCode == 0) {
      _cachedHashCode = Objects.hash(this.nameId, this.regions, this.maxPlayersNormal, this.maxPlayersDirect, this.maxPlayersParty, this.runtime);
    }
  ...
  public String toString() {
    return "LobbyGroup{" + "nameId: " + nameId + ", regions: " + regions + ", maxPlayersNormal: " + maxPlayersNormal + ", maxPlayersDirect: " + maxPlayersDirect + ", maxPlayersParty: " + maxPlayersParty + ", runtime: " + runtime + "}";
  }
