...
@JsonDeserialize(
    builder = CreateGameVersionRequest.Builder.class
)
public final class CreateGameVersionRequest {
  ...
  CreateGameVersionRequest(String displayName, Config config) {
  ...
  public String toString() {
    return "CreateGameVersionRequest{" + "displayName: " + displayName + ", config: " + config + "}";
  }
