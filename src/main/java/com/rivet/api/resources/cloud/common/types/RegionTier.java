...
@JsonDeserialize(
    builder = RegionTier.Builder.class
)
public final class RegionTier {
  ...
  RegionTier(String tierNameId, int rivetCoresNumerator, int rivetCoresDenominator, int cpu,
      int memory, int disk, int bandwidth, int pricePerSecond) {
  ...
  private boolean equalTo(RegionTier other) {
    return tierNameId.equals(other.tierNameId) && rivetCoresNumerator == other.rivetCoresNumerator && rivetCoresDenominator == other.rivetCoresDenominator && cpu == other.cpu && memory == other.memory && disk == other.disk && bandwidth == other.bandwidth && pricePerSecond == other.pricePerSecond;
  }

  @Override
  public int hashCode() {
    if (_cachedHashCode == 0) {
      _cachedHashCode = Objects.hash(this.tierNameId, this.rivetCoresNumerator, this.rivetCoresDenominator, this.cpu, this.memory, this.disk, this.bandwidth, this.pricePerSecond);
    }
  ...
  public String toString() {
    return "RegionTier{" + "tierNameId: " + tierNameId + ", rivetCoresNumerator: " + rivetCoresNumerator + ", rivetCoresDenominator: " + rivetCoresDenominator + ", cpu: " + cpu + ", memory: " + memory + ", disk: " + disk + ", bandwidth: " + bandwidth + ", pricePerSecond: " + pricePerSecond + "}";
  }
  ...
  public static final class Builder implements TierNameIdStage, RivetCoresNumeratorStage, RivetCoresDenominatorStage, CpuStage, MemoryStage, DiskStage, BandwidthStage, PricePerSecondStage, _FinalStage {
    ...
    public RegionTier build() {
      return new RegionTier(tierNameId, rivetCoresNumerator, rivetCoresDenominator, cpu, memory, disk, bandwidth, pricePerSecond);
    }
  }
}
