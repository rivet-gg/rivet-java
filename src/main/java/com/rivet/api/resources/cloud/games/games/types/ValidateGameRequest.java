...
@JsonDeserialize(
    builder = ValidateGameRequest.Builder.class
)
public final class ValidateGameRequest {
  ...
  ValidateGameRequest(String displayName, String nameId) {
  ...
  public String toString() {
    return "ValidateGameRequest{" + "displayName: " + displayName + ", nameId: " + nameId + "}";
  }
