...
@JsonDeserialize(
    builder = CreateGameNamespaceRequest.Builder.class
)
public final class CreateGameNamespaceRequest {
  ...
  CreateGameNamespaceRequest(String displayName, UUID versionId, String nameId) {
  ...
  private boolean equalTo(CreateGameNamespaceRequest other) {
    return displayName.equals(other.displayName) && versionId.equals(other.versionId) && nameId.equals(other.nameId);
  }

  @Override
  public int hashCode() {
    if (_cachedHashCode == 0) {
      _cachedHashCode = Objects.hash(this.displayName, this.versionId, this.nameId);
    }
  ...
  public String toString() {
    return "CreateGameNamespaceRequest{" + "displayName: " + displayName + ", versionId: " + versionId + ", nameId: " + nameId + "}";
  }
