...
@JsonDeserialize(builder = PrepareCustomAvatarUploadResponse.Builder.class)
public final class PrepareCustomAvatarUploadResponse {
    private final UUID uploadId;

    private final PresignedRequest presignedRequest;

    private PrepareCustomAvatarUploadResponse(UUID uploadId, PresignedRequest presignedRequest) {
