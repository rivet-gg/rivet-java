...
@JsonDeserialize(
    builder = GetDeviceLinkResponse.Builder.class
)
public final class GetDeviceLinkResponse {
  ...
  GetDeviceLinkResponse(Optional<String> cloudToken, WatchResponse watch) {
  ...
  public int hashCode() {
    if (_cachedHashCode == 0) {
      _cachedHashCode = Objects.hash(this.cloudToken, this.watch);
    }
  ...
  public String toString() {
    return "GetDeviceLinkResponse{" + "cloudToken: " + cloudToken + ", watch: " + watch + "}";
  }
