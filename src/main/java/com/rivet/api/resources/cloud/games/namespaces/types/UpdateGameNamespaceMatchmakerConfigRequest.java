...
@JsonDeserialize(builder = UpdateGameNamespaceMatchmakerConfigRequest.Builder.class)
public final class UpdateGameNamespaceMatchmakerConfigRequest {
    private final int lobbyCountMax;

    private final int maxPlayers;

    private UpdateGameNamespaceMatchmakerConfigRequest(int lobbyCountMax, int maxPlayers) {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof UpdateGameNamespaceMatchmakerConfigRequest
                && equalTo((UpdateGameNamespaceMatchmakerConfigRequest) other);
    }
