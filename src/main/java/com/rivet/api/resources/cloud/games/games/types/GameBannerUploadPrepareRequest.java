...
@JsonDeserialize(
    builder = GameBannerUploadPrepareRequest.Builder.class
)
public final class GameBannerUploadPrepareRequest {
  ...
  GameBannerUploadPrepareRequest(String path, Optional<String> mime, Optional<Long> contentLength) {
    this.path = path;
    this.mime = mime;
  ...
  public String toString() {
    return "GameBannerUploadPrepareRequest{" + "path: " + path + ", mime: " + mime + ", contentLength: " + contentLength + "}";
  }
