...
@JsonDeserialize(builder = GetGameNamespaceVersionHistoryResponse.Builder.class)
public final class GetGameNamespaceVersionHistoryResponse {
    private final List<NamespaceVersion> versions;

    private GetGameNamespaceVersionHistoryResponse(List<NamespaceVersion> versions) {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof GetGameNamespaceVersionHistoryResponse
                && equalTo((GetGameNamespaceVersionHistoryResponse) other);
    }
