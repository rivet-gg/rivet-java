...
@JsonDeserialize(
    builder = LobbySummaryAnalytics.Builder.class
)
public final class LobbySummaryAnalytics {
  ...
  LobbySummaryAnalytics(UUID lobbyId, UUID lobbyGroupId, String lobbyGroupNameId, UUID regionId,
      String createTs, boolean isReady, boolean isIdle, boolean isClosed, boolean isOutdated,
      int maxPlayersNormal, int maxPlayersDirect, int maxPlayersParty, int totalPlayerCount,
  ...
  private boolean equalTo(LobbySummaryAnalytics other) {
    return lobbyId.equals(other.lobbyId) && lobbyGroupId.equals(other.lobbyGroupId) && lobbyGroupNameId.equals(other.lobbyGroupNameId) && regionId.equals(other.regionId) && createTs.equals(other.createTs) && isReady == other.isReady && isIdle == other.isIdle && isClosed == other.isClosed && isOutdated == other.isOutdated && maxPlayersNormal == other.maxPlayersNormal && maxPlayersDirect == other.maxPlayersDirect && maxPlayersParty == other.maxPlayersParty && totalPlayerCount == other.totalPlayerCount && registeredPlayerCount == other.registeredPlayerCount;
  }

  @Override
  public int hashCode() {
    if (_cachedHashCode == 0) {
      _cachedHashCode = Objects.hash(this.lobbyId, this.lobbyGroupId, this.lobbyGroupNameId, this.regionId, this.createTs, this.isReady, this.isIdle, this.isClosed, this.isOutdated, this.maxPlayersNormal, this.maxPlayersDirect, this.maxPlayersParty, this.totalPlayerCount, this.registeredPlayerCount);
    }
  ...
  public String toString() {
    return "LobbySummaryAnalytics{" + "lobbyId: " + lobbyId + ", lobbyGroupId: " + lobbyGroupId + ", lobbyGroupNameId: " + lobbyGroupNameId + ", regionId: " + regionId + ", createTs: " + createTs + ", isReady: " + isReady + ", isIdle: " + isIdle + ", isClosed: " + isClosed + ", isOutdated: " + isOutdated + ", maxPlayersNormal: " + maxPlayersNormal + ", maxPlayersDirect: " + maxPlayersDirect + ", maxPlayersParty: " + maxPlayersParty + ", totalPlayerCount: " + totalPlayerCount + ", registeredPlayerCount: " + registeredPlayerCount + "}";
  }
  ...
  public interface CreateTsStage {
    IsReadyStage createTs(String createTs);
  }
  ...
  public static final class Builder implements LobbyIdStage, LobbyGroupIdStage, LobbyGroupNameIdStage, RegionIdStage, CreateTsStage, IsReadyStage, IsIdleStage, IsClosedStage, IsOutdatedStage, MaxPlayersNormalStage, MaxPlayersDirectStage, MaxPlayersPartyStage, TotalPlayerCountStage, RegisteredPlayerCountStage, _FinalStage {
    ...
    public IsReadyStage createTs(String createTs) {
      this.createTs = createTs;
      return this;
    }
    ...
    public LobbySummaryAnalytics build() {
      return new LobbySummaryAnalytics(lobbyId, lobbyGroupId, lobbyGroupNameId, regionId, createTs, isReady, isIdle, isClosed, isOutdated, maxPlayersNormal, maxPlayersDirect, maxPlayersParty, totalPlayerCount, registeredPlayerCount);
    }
  }
}
