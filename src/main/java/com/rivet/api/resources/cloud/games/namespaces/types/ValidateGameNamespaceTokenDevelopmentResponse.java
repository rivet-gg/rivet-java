...
@JsonDeserialize(
    builder = ValidateGameNamespaceTokenDevelopmentResponse.Builder.class
)
public final class ValidateGameNamespaceTokenDevelopmentResponse {
  ...
  ValidateGameNamespaceTokenDevelopmentResponse(List<ValidationError> errors) {
    this.errors = errors;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof ValidateGameNamespaceTokenDevelopmentResponse && equalTo((ValidateGameNamespaceTokenDevelopmentResponse) other);
  }
  ...
  public String toString() {
    return "ValidateGameNamespaceTokenDevelopmentResponse{" + "errors: " + errors + "}";
  }
