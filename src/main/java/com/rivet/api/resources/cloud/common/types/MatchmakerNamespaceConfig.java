...
@JsonDeserialize(
    builder = MatchmakerNamespaceConfig.Builder.class
)
public final class MatchmakerNamespaceConfig {
  ...
  MatchmakerNamespaceConfig(int lobbyCountMax, int maxPlayersPerClient, int maxPlayersPerClientVpn,
      int maxPlayersPerClientProxy, int maxPlayersPerClientTor, int maxPlayersPerClientHosting) {
  ...
  private boolean equalTo(MatchmakerNamespaceConfig other) {
    return lobbyCountMax == other.lobbyCountMax && maxPlayersPerClient == other.maxPlayersPerClient && maxPlayersPerClientVpn == other.maxPlayersPerClientVpn && maxPlayersPerClientProxy == other.maxPlayersPerClientProxy && maxPlayersPerClientTor == other.maxPlayersPerClientTor && maxPlayersPerClientHosting == other.maxPlayersPerClientHosting;
  }

  @Override
  public int hashCode() {
    if (_cachedHashCode == 0) {
      _cachedHashCode = Objects.hash(this.lobbyCountMax, this.maxPlayersPerClient, this.maxPlayersPerClientVpn, this.maxPlayersPerClientProxy, this.maxPlayersPerClientTor, this.maxPlayersPerClientHosting);
    }
  ...
  public String toString() {
    return "MatchmakerNamespaceConfig{" + "lobbyCountMax: " + lobbyCountMax + ", maxPlayersPerClient: " + maxPlayersPerClient + ", maxPlayersPerClientVpn: " + maxPlayersPerClientVpn + ", maxPlayersPerClientProxy: " + maxPlayersPerClientProxy + ", maxPlayersPerClientTor: " + maxPlayersPerClientTor + ", maxPlayersPerClientHosting: " + maxPlayersPerClientHosting + "}";
  }
  ...
  public static final class Builder implements LobbyCountMaxStage, MaxPlayersPerClientStage, MaxPlayersPerClientVpnStage, MaxPlayersPerClientProxyStage, MaxPlayersPerClientTorStage, MaxPlayersPerClientHostingStage, _FinalStage {
    ...
    public MatchmakerNamespaceConfig build() {
      return new MatchmakerNamespaceConfig(lobbyCountMax, maxPlayersPerClient, maxPlayersPerClientVpn, maxPlayersPerClientProxy, maxPlayersPerClientTor, maxPlayersPerClientHosting);
    }
  }
}
