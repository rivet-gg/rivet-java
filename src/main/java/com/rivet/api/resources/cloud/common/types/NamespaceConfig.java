...
@JsonDeserialize(
    builder = NamespaceConfig.Builder.class
)
public final class NamespaceConfig {
  ...
  NamespaceConfig(CdnNamespaceConfig cdn, MatchmakerNamespaceConfig matchmaker,
      KvNamespaceConfig kv, IdentityNamespaceConfig identity) {
    this.cdn = cdn;
  ...
  public String toString() {
    return "NamespaceConfig{" + "cdn: " + cdn + ", matchmaker: " + matchmaker + ", kv: " + kv + ", identity: " + identity + "}";
  }
