...
@JsonDeserialize(
    builder = CdnNamespaceConfig.Builder.class
)
public final class CdnNamespaceConfig {
  ...
  CdnNamespaceConfig(boolean enableDomainPublicAuth, List<CdnNamespaceDomain> domains,
      CdnAuthType authType, List<CdnNamespaceAuthUser> authUserList) {
  ...
  private boolean equalTo(CdnNamespaceConfig other) {
    return enableDomainPublicAuth == other.enableDomainPublicAuth && domains.equals(other.domains) && authType.equals(other.authType) && authUserList.equals(other.authUserList);
  }

  @Override
  public int hashCode() {
    if (_cachedHashCode == 0) {
      _cachedHashCode = Objects.hash(this.enableDomainPublicAuth, this.domains, this.authType, this.authUserList);
    }
  ...
  public String toString() {
    return "CdnNamespaceConfig{" + "enableDomainPublicAuth: " + enableDomainPublicAuth + ", domains: " + domains + ", authType: " + authType + ", authUserList: " + authUserList + "}";
  }
