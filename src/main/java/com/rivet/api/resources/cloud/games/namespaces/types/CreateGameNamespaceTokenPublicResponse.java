...
@JsonDeserialize(builder = CreateGameNamespaceTokenPublicResponse.Builder.class)
public final class CreateGameNamespaceTokenPublicResponse {
    private final String token;

    private CreateGameNamespaceTokenPublicResponse(String token) {
        this.token = token;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CreateGameNamespaceTokenPublicResponse
                && equalTo((CreateGameNamespaceTokenPublicResponse) other);
    }
