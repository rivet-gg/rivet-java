...
public final class Config {
  ...
  Config(Optional<List<String>> displayNames, Optional<List<UUID>> avatars,
  ...
  private boolean equalTo(Config other) {
    return displayNames.equals(other.displayNames) && avatars.equals(other.avatars) && customDisplayNames.equals(other.customDisplayNames) && customAvatars.equals(other.customAvatars);
  }

  @Override
  public int hashCode() {
    if (_cachedHashCode == 0) {
      _cachedHashCode = Objects.hash(this.displayNames, this.avatars, this.customDisplayNames, this.customAvatars);
    }
  ...
  public String toString() {
    return "Config{" + "displayNames: " + displayNames + ", avatars: " + avatars + ", customDisplayNames: " + customDisplayNames + ", customAvatars: " + customAvatars + "}";
  }
