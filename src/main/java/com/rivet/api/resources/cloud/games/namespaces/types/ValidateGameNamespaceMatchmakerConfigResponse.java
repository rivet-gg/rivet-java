...
@JsonDeserialize(builder = ValidateGameNamespaceMatchmakerConfigResponse.Builder.class)
public final class ValidateGameNamespaceMatchmakerConfigResponse {
    private final List<ValidationError> errors;

    private ValidateGameNamespaceMatchmakerConfigResponse(List<ValidationError> errors) {
        this.errors = errors;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ValidateGameNamespaceMatchmakerConfigResponse
                && equalTo((ValidateGameNamespaceMatchmakerConfigResponse) other);
    }
