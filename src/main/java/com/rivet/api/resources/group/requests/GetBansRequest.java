...
@JsonDeserialize(
    builder = GetBansRequest.Builder.class
)
public final class GetBansRequest {
  ...
  GetBansRequest(Optional<String> anchor, Optional<Double> count, Optional<String> watchIndex) {
    this.anchor = anchor;
    this.count = count;
  ...
  /**
   * @return Amount of bans to return.
   */
  @JsonProperty("count")
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof GetBansRequest && equalTo((GetBansRequest) other);
  }

  private boolean equalTo(GetBansRequest other) {
  ...
  public String toString() {
    return "GetBansRequest{" + "anchor: " + anchor + ", count: " + count + ", watchIndex: " + watchIndex + "}";
  }
  ...
  public static final class Builder {
    ...
    public Builder from(GetBansRequest other) {
    ...
    public GetBansRequest build() {
      return new GetBansRequest(anchor, count, watchIndex);
    }
  }
}
