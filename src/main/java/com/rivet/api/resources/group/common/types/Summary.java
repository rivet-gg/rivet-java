...
public final class Summary {
  ...
  Summary(UUID groupId, String displayName, Optional<String> avatarUrl, ExternalLinks external,
      boolean isDeveloper, String bio, boolean isCurrentIdentityMember, Publicity publicity,
      int memberCount, UUID ownerIdentityId) {
  ...
  private boolean equalTo(Summary other) {
    return groupId.equals(other.groupId) && displayName.equals(other.displayName) && avatarUrl.equals(other.avatarUrl) && external.equals(other.external) && isDeveloper == other.isDeveloper && bio.equals(other.bio) && isCurrentIdentityMember == other.isCurrentIdentityMember && publicity.equals(other.publicity) && memberCount == other.memberCount && ownerIdentityId.equals(other.ownerIdentityId);
  }

  @Override
  public int hashCode() {
    if (_cachedHashCode == 0) {
      _cachedHashCode = Objects.hash(this.groupId, this.displayName, this.avatarUrl, this.external, this.isDeveloper, this.bio, this.isCurrentIdentityMember, this.publicity, this.memberCount, this.ownerIdentityId);
    }
  ...
  public String toString() {
    return "Summary{" + "groupId: " + groupId + ", displayName: " + displayName + ", avatarUrl: " + avatarUrl + ", external: " + external + ", isDeveloper: " + isDeveloper + ", bio: " + bio + ", isCurrentIdentityMember: " + isCurrentIdentityMember + ", publicity: " + publicity + ", memberCount: " + memberCount + ", ownerIdentityId: " + ownerIdentityId + "}";
  }
  ...
  public static final class Builder implements GroupIdStage, DisplayNameStage, ExternalStage, IsDeveloperStage, BioStage, IsCurrentIdentityMemberStage, PublicityStage, MemberCountStage, OwnerIdentityIdStage, _FinalStage {
    ...
    public Summary build() {
      return new Summary(groupId, displayName, avatarUrl, external, isDeveloper, bio, isCurrentIdentityMember, publicity, memberCount, ownerIdentityId);
    }
  }
}
