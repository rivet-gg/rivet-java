...
@JsonDeserialize(
    builder = PrepareAvatarUploadRequest.Builder.class
)
public final class PrepareAvatarUploadRequest {
  ...
  PrepareAvatarUploadRequest(String path, Optional<String> mime, long contentLength) {
    this.path = path;
    this.mime = mime;
  ...
  public String toString() {
    return "PrepareAvatarUploadRequest{" + "path: " + path + ", mime: " + mime + ", contentLength: " + contentLength + "}";
  }
