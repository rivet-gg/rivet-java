...
@JsonDeserialize(
    builder = ListSuggestedResponse.Builder.class
)
public final class ListSuggestedResponse {
  ...
  ListSuggestedResponse(List<Summary> groups, WatchResponse watch) {
    this.groups = groups;
    this.watch = watch;
  }
  ...
  public int hashCode() {
    if (_cachedHashCode == 0) {
      _cachedHashCode = Objects.hash(this.groups, this.watch);
    }
  ...
  public String toString() {
    return "ListSuggestedResponse{" + "groups: " + groups + ", watch: " + watch + "}";
  }
