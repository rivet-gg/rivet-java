...
@JsonDeserialize(
    builder = GetJoinRequestsRequest.Builder.class
)
public final class GetJoinRequestsRequest {
  ...
  GetJoinRequestsRequest(Optional<String> anchor, Optional<Double> count,
      Optional<String> watchIndex) {
    this.anchor = anchor;
    this.count = count;
  ...
  /**
   * @return Amount of join requests to return.
   */
  @JsonProperty("count")
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof GetJoinRequestsRequest && equalTo((GetJoinRequestsRequest) other);
  }

  private boolean equalTo(GetJoinRequestsRequest other) {
  ...
  public int hashCode() {
    if (_cachedHashCode == 0) {
      _cachedHashCode = Objects.hash(this.anchor, this.count, this.watchIndex);
    }
  ...
  public String toString() {
    return "GetJoinRequestsRequest{" + "anchor: " + anchor + ", count: " + count + ", watchIndex: " + watchIndex + "}";
  }
  ...
  public static final class Builder {
    ...
    public Builder from(GetJoinRequestsRequest other) {
    ...
    public GetJoinRequestsRequest build() {
      return new GetJoinRequestsRequest(anchor, count, watchIndex);
    }
  }
}
