...
@JsonDeserialize(
    builder = GetMembersRequest.Builder.class
)
public final class GetMembersRequest {
  ...
  GetMembersRequest(Optional<String> anchor, Optional<Double> count, Optional<String> watchIndex) {
    this.anchor = anchor;
    this.count = count;
  ...
  public String toString() {
    return "GetMembersRequest{" + "anchor: " + anchor + ", count: " + count + ", watchIndex: " + watchIndex + "}";
  }
