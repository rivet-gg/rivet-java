...
@JsonDeserialize(builder = CreateLobbyResponse.Builder.class)
public final class CreateLobbyResponse {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CreateLobbyResponse && equalTo((CreateLobbyResponse) other);
    }
    ...
    public interface LobbyStage {
        ...
        Builder from(CreateLobbyResponse other);
    }
    ...
    public static final class Builder implements LobbyStage, PlayerStage, _FinalStage {
        ...
        public CreateLobbyResponse build() {
            return new CreateLobbyResponse(lobby, ports, player);
        }
    }
}
