...
@JsonDeserialize(
    builder = GetGameLinkResponse.Builder.class
)
public final class GetGameLinkResponse {
  ...
  GetGameLinkResponse(GameLinkStatus status, Handle game,
      com.rivet.api.resources.identity.common.types.Handle currentIdentity,
      Optional<GetGameLinkNewIdentity> newIdentity, WatchResponse watch) {
    this.status = status;
    this.game = game;
  ...
  private boolean equalTo(GetGameLinkResponse other) {
    return status.equals(other.status) && game.equals(other.game) && currentIdentity.equals(other.currentIdentity) && newIdentity.equals(other.newIdentity) && watch.equals(other.watch);
  }

  @Override
  public int hashCode() {
    if (_cachedHashCode == 0) {
      _cachedHashCode = Objects.hash(this.status, this.game, this.currentIdentity, this.newIdentity, this.watch);
    }
  ...
  public String toString() {
    return "GetGameLinkResponse{" + "status: " + status + ", game: " + game + ", currentIdentity: " + currentIdentity + ", newIdentity: " + newIdentity + ", watch: " + watch + "}";
  }
  ...
  public static final class Builder implements StatusStage, GameStage, CurrentIdentityStage, WatchStage, _FinalStage {
    ...
    public WatchStage currentIdentity(
        com.rivet.api.resources.identity.common.types.Handle currentIdentity) {
      this.currentIdentity = currentIdentity;
      return this;
    }
