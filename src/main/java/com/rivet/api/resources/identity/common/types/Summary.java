...
public final class Summary {
  ...
  private final Optional<Handle> party;
  ...
  Summary(UUID identityId, String displayName, int accountNumber, String avatarUrl,
      Optional<Presence> presence, Optional<Handle> party, boolean isRegistered,
      ExternalLinks external, boolean following, boolean isFollowingMe, boolean isMutualFollowing) {
  ...
  @JsonProperty("party")
  public Optional<Handle> getParty() {
    return party;
  }
  ...
  public String toString() {
    return "Summary{" + "identityId: " + identityId + ", displayName: " + displayName + ", accountNumber: " + accountNumber + ", avatarUrl: " + avatarUrl + ", presence: " + presence + ", party: " + party + ", isRegistered: " + isRegistered + ", external: " + external + ", following: " + following + ", isFollowingMe: " + isFollowingMe + ", isMutualFollowing: " + isMutualFollowing + "}";
  }
  ...
  public interface _FinalStage {
    ...
    _FinalStage party(Optional<Handle> party);
  ...
  public static final class Builder implements IdentityIdStage, DisplayNameStage, AccountNumberStage, AvatarUrlStage, IsRegisteredStage, ExternalStage, FollowingStage, IsFollowingMeStage, IsMutualFollowingStage, _FinalStage {
    ...
    private Optional<Handle> party = Optional.empty();
    ...
    public _FinalStage party(Optional<Handle> party) {
      this.party = party;
      return this;
    }
    ...
    public Summary build() {
      return new Summary(identityId, displayName, accountNumber, avatarUrl, presence, party, isRegistered, external, following, isFollowingMe, isMutualFollowing);
    }
  }
}
