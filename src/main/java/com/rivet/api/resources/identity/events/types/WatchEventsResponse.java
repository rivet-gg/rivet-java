...
@JsonDeserialize(
    builder = WatchEventsResponse.Builder.class
)
public final class WatchEventsResponse {
  ...
  WatchEventsResponse(List<GlobalEvent> events, WatchResponse watch) {
    this.events = events;
    this.watch = watch;
  }
  ...
  public int hashCode() {
    if (_cachedHashCode == 0) {
      _cachedHashCode = Objects.hash(this.events, this.watch);
    }
  ...
  public String toString() {
    return "WatchEventsResponse{" + "events: " + events + ", watch: " + watch + "}";
  }
