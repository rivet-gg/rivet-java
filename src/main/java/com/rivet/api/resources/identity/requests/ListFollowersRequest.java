...
@JsonDeserialize(
    builder = ListFollowersRequest.Builder.class
)
public final class ListFollowersRequest {
  ...
  ListFollowersRequest(Optional<String> anchor, Optional<String> limit) {
    this.anchor = anchor;
    this.limit = limit;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof ListFollowersRequest && equalTo((ListFollowersRequest) other);
  }

  private boolean equalTo(ListFollowersRequest other) {
  ...
  public String toString() {
    return "ListFollowersRequest{" + "anchor: " + anchor + ", limit: " + limit + "}";
  }
  ...
  public static final class Builder {
    ...
    public Builder from(ListFollowersRequest other) {
    ...
    public ListFollowersRequest build() {
      return new ListFollowersRequest(anchor, limit);
    }
  }
}
