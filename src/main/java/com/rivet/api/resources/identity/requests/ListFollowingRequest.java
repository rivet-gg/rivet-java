...
@JsonDeserialize(
    builder = ListFollowingRequest.Builder.class
)
public final class ListFollowingRequest {
  ...
  ListFollowingRequest(Optional<String> anchor, Optional<String> limit) {
    this.anchor = anchor;
    this.limit = limit;
  }
  ...
  public String toString() {
    return "ListFollowingRequest{" + "anchor: " + anchor + ", limit: " + limit + "}";
  }
