...
public final class ExternalLinks {
  ...
  ExternalLinks(String profile, Optional<String> settings, Optional<String> chat) {
  ...
  public int hashCode() {
    if (_cachedHashCode == 0) {
      _cachedHashCode = Objects.hash(this.profile, this.settings, this.chat);
    }
  ...
  public String toString() {
    return "ExternalLinks{" + "profile: " + profile + ", settings: " + settings + ", chat: " + chat + "}";
  }
