...
@JsonDeserialize(
    builder = GlobalEventMatchmakerLobbyJoin.Builder.class
)
public final class GlobalEventMatchmakerLobbyJoin {
  ...
  GlobalEventMatchmakerLobbyJoin(JoinLobby lobby, Map<String, JoinPort> ports, JoinPlayer player) {
    this.lobby = lobby;
    this.ports = ports;
    this.player = player;
  }
  ...
  public String toString() {
    return "GlobalEventMatchmakerLobbyJoin{" + "lobby: " + lobby + ", ports: " + ports + ", player: " + player + "}";
  }
