...
@JsonDeserialize(builder = ValidateProfileRequest.Builder.class)
public final class ValidateProfileRequest {
    ...
    private ValidateProfileRequest(
            Optional<String> displayName, Optional<Integer> accountNumber, Optional<String> bio) {
