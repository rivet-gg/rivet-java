...
@JsonDeserialize(
    builder = ListMutualFriendsRequest.Builder.class
)
public final class ListMutualFriendsRequest {
  ...
  ListMutualFriendsRequest(Optional<String> anchor, Optional<String> limit) {
    this.anchor = anchor;
    this.limit = limit;
  }
  ...
  public String toString() {
    return "ListMutualFriendsRequest{" + "anchor: " + anchor + ", limit: " + limit + "}";
  }
