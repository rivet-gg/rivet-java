...
@JsonDeserialize(
    builder = UpdateProfileRequest.Builder.class
)
public final class UpdateProfileRequest {
  ...
  UpdateProfileRequest(Optional<String> displayName, Optional<Integer> accountNumber,
      Optional<String> bio) {
  ...
  public String toString() {
    return "UpdateProfileRequest{" + "displayName: " + displayName + ", accountNumber: " + accountNumber + ", bio: " + bio + "}";
  }
  ...
  public static final class Builder {
    ...
    public UpdateProfileRequest build() {
      return new UpdateProfileRequest(displayName, accountNumber, bio);
    }
  }
}
