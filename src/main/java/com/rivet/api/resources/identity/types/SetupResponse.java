...
@JsonDeserialize(
    builder = SetupResponse.Builder.class
)
public final class SetupResponse {
  ...
  SetupResponse(String identityToken, String identityTokenExpireTs, Profile identity, UUID gameId) {
  ...
  private boolean equalTo(SetupResponse other) {
    return identityToken.equals(other.identityToken) && identityTokenExpireTs.equals(other.identityTokenExpireTs) && identity.equals(other.identity) && gameId.equals(other.gameId);
  }

  @Override
  public int hashCode() {
    if (_cachedHashCode == 0) {
      _cachedHashCode = Objects.hash(this.identityToken, this.identityTokenExpireTs, this.identity, this.gameId);
    }
  ...
  public String toString() {
    return "SetupResponse{" + "identityToken: " + identityToken + ", identityTokenExpireTs: " + identityTokenExpireTs + ", identity: " + identity + ", gameId: " + gameId + "}";
  }
