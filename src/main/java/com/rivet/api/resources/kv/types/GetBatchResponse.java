...
@JsonDeserialize(
    builder = GetBatchResponse.Builder.class
)
public final class GetBatchResponse {
  ...
  GetBatchResponse(List<Entry> entries, WatchResponse watch) {
  ...
  public int hashCode() {
    if (_cachedHashCode == 0) {
      _cachedHashCode = Objects.hash(this.entries, this.watch);
    }
  ...
  public String toString() {
    return "GetBatchResponse{" + "entries: " + entries + ", watch: " + watch + "}";
  }
