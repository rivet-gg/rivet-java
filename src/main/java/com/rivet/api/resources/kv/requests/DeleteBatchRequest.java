...
@JsonDeserialize(
    builder = DeleteBatchRequest.Builder.class
)
public final class DeleteBatchRequest {
  ...
  DeleteBatchRequest(String keys, Optional<UUID> namespaceId) {
    this.keys = keys;
  ...
  public int hashCode() {
    if (_cachedHashCode == 0) {
      _cachedHashCode = Objects.hash(this.keys, this.namespaceId);
    }
  ...
  public String toString() {
    return "DeleteBatchRequest{" + "keys: " + keys + ", namespaceId: " + namespaceId + "}";
  }
