...
public final class ErrorBody {
  ...
  ErrorBody(String code, String message, Optional<String> documentation,
  ...
  private boolean equalTo(ErrorBody other) {
    return code.equals(other.code) && message.equals(other.message) && documentation.equals(other.documentation) && metadata.equals(other.metadata);
  }

  @Override
  public int hashCode() {
    if (_cachedHashCode == 0) {
      _cachedHashCode = Objects.hash(this.code, this.message, this.documentation, this.metadata);
    }
  ...
  public String toString() {
    return "ErrorBody{" + "code: " + code + ", message: " + message + ", documentation: " + documentation + ", metadata: " + metadata + "}";
  }
