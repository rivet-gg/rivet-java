...
@JsonDeserialize(
    builder = CreatePublicityConfig.Builder.class
)
public final class CreatePublicityConfig {
  ...
  CreatePublicityConfig(Optional<PublicityLevel> public_, Optional<PublicityLevel> mutualFollowers,
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof CreatePublicityConfig && equalTo((CreatePublicityConfig) other);
  }

  private boolean equalTo(CreatePublicityConfig other) {
  ...
  public String toString() {
    return "CreatePublicityConfig{" + "public_: " + public_ + ", mutualFollowers: " + mutualFollowers + ", groups: " + groups + "}";
  }
  ...
  public static final class Builder {
    ...
    public Builder from(CreatePublicityConfig other) {
    ...
    public CreatePublicityConfig build() {
      return new CreatePublicityConfig(public_, mutualFollowers, groups);
    }
  }
}
