...
@JsonDeserialize(
    builder = GetSelfSummaryRequest.Builder.class
)
public final class GetSelfSummaryRequest {
  private final Optional<String> watchIndex;

  private int _cachedHashCode;

  GetSelfSummaryRequest(Optional<String> watchIndex) {
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof GetSelfSummaryRequest && equalTo((GetSelfSummaryRequest) other);
  }

  private boolean equalTo(GetSelfSummaryRequest other) {
  ...
  public String toString() {
    return "GetSelfSummaryRequest{" + "watchIndex: " + watchIndex + "}";
  }
  ...
  public static final class Builder {
    ...
    public Builder from(GetSelfSummaryRequest other) {
    ...
    public GetSelfSummaryRequest build() {
      return new GetSelfSummaryRequest(watchIndex);
    }
  }
}
