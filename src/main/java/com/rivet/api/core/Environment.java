...
public final class Environment {
  ...
  Environment(String admin, String auth, String chat, String cloud, String group, String identity,
      String job, String kv, String matchmaker, String party, String portal) {
    this.admin = admin;
    this.auth = auth;
    this.chat = chat;
    this.cloud = cloud;
